    ...
    <div id="analysisForm">
        <fieldset class="inputFields">
            ...
            <div class="highDimContainer">
                <span>Select a <b>high dimensional</b> data node from the Data Set Explorer Tree and drag it into the box.
                    If desired, use the High Dimensional Data button below the box to select one or more genes.</span>
