...
<body>
	<form>
        ...
        <g:if test="${zipLink}">
			...
			<g:if test="${grailsApplication.config.org.transmartproject.helpUrls.waterfallFiles}">
				&nbsp;
				<a target="_blank" href="${grailsApplication.config.org.transmartproject.helpUrls.waterfallFiles}">
