    ...
    <form>
      ...
      <br />
        ...
        <g:if test="${zipLink}">
            ...
            <g:if test="${grailsApplication.config.org.transmartproject.helpUrls.kMeansClusteringFiles}">
              &nbsp;
              <a target="_blank" href="${grailsApplication.config.org.transmartproject.helpUrls.kMeansClusteringFiles}">
