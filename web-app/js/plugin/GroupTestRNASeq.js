    ...
    init: function () {
        ...
        var childPanelConfig = [
            ...
            },
            {
                ...
                toolTipTxt: 'Drag and drop categorical data nodes to define groups to associate RNAseq data with. ' +
                'Please keep in mind that only groups belonging to a single variable can be compared, ' +
                'e.g. Male and Female (both Gender), ' +
                'but not e.g. Male and MSI (Gender and Microsatellite instability).'  +
